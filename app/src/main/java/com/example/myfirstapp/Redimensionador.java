...
public class Redimensionador extends BaseAdapter {
    private Context mContext;
    private AssetManager am;
    private String[] files;

    public Redimensionador(Context c) {
        mContext = c;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.redimensionador_main, null);
        }

        final ImageView imageView = convertView.findViewById(R.id.redimensionado);
